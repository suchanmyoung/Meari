...
<body>
<form name="articleForm"action="/sns/writing" method="post" enctype="multipart/form-data">
    <div class="commercePostWrap">
       
        <!--  <p class="share">공유</p> -->
        <div class="postContainer">
           <p class="main">새 게시물</p>
       ...
       <div class="contantsContainer">
           <input type="text" class="title" placeholder="글 제목" name="sns_title">
           <textarea class="detail" cols="10" rows="10" name="sns_content"></textarea>  
        </div>        
